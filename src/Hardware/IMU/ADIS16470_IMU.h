...
class ADIS16470_IMU : public nt::NTSendable,
 ...
 private:
  ...
  // ADIS16470 Constants
  static constexpr double delta_angle_sf = 2160.0 / 2147483648.0; /* 2160 / (2^31) */
  ...
  frc::SPI::Port m_spi_port;
  uint16_t m_calibration_time = 0;
  frc::SPI* m_spi = nullptr;
  frc::DigitalInput* m_auto_interrupt = nullptr;
